...
package Pcre.Wide_Matcher is
   ...
   procedure Match
     (Code        : Wide_String; -- the compiled pattern
      Data        : Wide_String;
      Match_Data  : in out Pcre.Wide_Matcher.Match_Data'Class;
      Data_First  : Integer      := -1;
      Data_Last   : Positive     := Positive'Last;
   ...
   function Get (Match_Data : Pcre.Wide_Matcher.Match_Data'Class) return Substring_List;
...
private
   ...
   type Callout_Block is new Pcre.Low_Level.Pcre2_H.Pcre2_Callout_Block_16;
   type Callout_Enumerate_Block  is new Pcre.Low_Level.Pcre2_H.Pcre2_Callout_Enumerate_Block_16;
   type Substitute_Callout_Block  is new Pcre.Low_Level.Pcre2_H.Pcre2_Substitute_Callout_Block_16;
