...
with Pcre.Low_Level.Linker_Options_32;
package body Pcre.Wide_Wide_Matcher is
   function As_PCRE2_SPTR32 is new Ada.Unchecked_Conversion (System.Address, PCRE2_SPTR32);

   function Get_Error_Message (Code : int) return Wide_Wide_String is
      Ret    : int;
      Buffer : Wide_Wide_String (1 .. 1024);
   begin
      Ret := Pcre2_Get_Error_Message_32 (Code, As_PCRE2_SPTR32 (Buffer'Address), Buffer'Length);
   ...
   is
   begin
      Retcode_2_Exception (Pcre2_Set_Bsr_32 (Context.Impl, Bsr_Type_Maping (Bsr)));
   end Set;

   --------------------------
   -- Set_Wide_Wide_Character_Tables --
   --------------------------

   procedure Set_Wide_Wide_Character_Tables
     (Context : Compile_Context; To : Wide_Wide_Character_Tables)
   is
      Data : aliased Unsigned_Char with Address => To.all'Address;
   begin
      Retcode_2_Exception (Pcre2_Set_Character_Tables_32 (Context.Impl, To));
   end Set_Wide_Wide_Character_Tables;
   ...
   is
   begin
      Retcode_2_Exception (Pcre2_Set_Compile_Extra_Options_32 (Context.Impl, Unsigned (Options)));
   ...
   is
   begin
      Retcode_2_Exception (Pcre2_Set_Max_Pattern_Length_32 (Context.Impl, unsigned_long (Length)));
   ...
   is
   begin
      Retcode_2_Exception (Pcre2_Set_Newline_32 (Context.Impl, NEW_LINE_MAP (Arg2)));
   end Set_Newline;
   ...
   is
   begin
      Retcode_2_Exception (Pcre2_Set_Parens_Nest_Limit_32 (Context.Impl, UNSIGNED (Limit)));
   ...
   begin
      Arg1.Guard := Guard;
      null;
      --  Retcode_2_Exception (Pcre2_Set_Compile_Recursion_Guard_32 (Arg1.Impl, Arg2, Arg1.all'Address));
   ...
   is
   begin
      Retcode_2_Exception (Pcre2_Set_Glob_Escape_32 (Context.Impl, Wide_Wide_Character'Pos (Escape_Wide_Wide_Character)));
   end Set_Glob_Escape;
   ...
   is
   begin
      Retcode_2_Exception (Pcre2_Set_Glob_Separator_32 (Context.Impl, Glob_Separator'Pos (Separator)));
   ...
   procedure Converted_Pattern_Free (Arg1 : access Wide_Wide_Character) is
   begin
   ...
   begin
      Retcode_2_Exception (Pcre2_Set_Heap_Limit_32 (Context.Impl, Unsigned (Limit)));
   end Set_Heap_Limit;
   ...
   begin
      Retcode_2_Exception (Pcre2_Set_Match_Limit_32 (Context.Impl, Unsigned (Limit)));
   end Set_Match_Limit;
   ...
   is
   begin
      Retcode_2_Exception (Pcre2_Set_Offset_Limit_32 (Context.Impl, unsigned_long (Limit)));
   ...
   is
   begin
      Retcode_2_Exception (Pcre2_Set_Recursion_Limit_32 (Arg1.Impl, Unsigned (Arg2)));
   ...
   -------------
   function Compile
     (Pattern : Wide_Wide_String;           --  A string containing expression to be compiled
   ...
   begin
      return Ret : Code do
         Ret.Impl := Pcre2_Compile_32 (As_PCRE2_SPTR32 (Pattern (Pattern'First)'Address),
                                      Pattern'Length,
                                      Unsigned (Options),
                                      Errocode'Access,
                                      Erroroffset'Access,
   ...
   begin
      Finalize (Into);
      Into.Impl := Pcre2_Compile_32 (As_PCRE2_SPTR32 (Pattern (Pattern'First)'Address),
                                    Pattern'Length,
                                    Unsigned (Options),
                                    Errocode'Access,
                                    Erroroffset'Access,
   ...
   begin
      Match_Data.Impl := Pcre2_Match_Data_Create_32 (Unsigned (Size), Context.Impl);
   end;
   ...
   begin
      return Ret : Match_Data do
         Ret.Impl := Pcre2_Match_Data_Create_32 (Unsigned (Size), Context.Impl);
      end return;
   end Create;
   ...
   begin
      return Ret : Match_Data do
         Ret.Impl := Pcre2_Match_Data_Create_From_Pattern_32 (Code.Impl, Context.Impl);
      end return;
   end Create;
   ...
   procedure Initialize (Match_Data : in out Pcre.Wide_Wide_Matcher.Match_Data;
                         ...
                         Context    : General_Context'Class := Null_General_Context)is
   begin
      Match_Data.Impl := Pcre2_Match_Data_Create_From_Pattern_32 (Code.Impl, Context.Impl);
   end;
   ...
   function Get_Mark (Match_Data : Pcre.Wide_Wide_Matcher.Match_Data) return access Wide_Wide_Character is
   begin
   ...
   is
   begin
      return Natural (Pcre2_Get_Match_Data_Size_32 (Match_Data.Impl));
   end Get_Size;
   ...
   function Get_Ovector_Count (Match_Data : Pcre.Wide_Wide_Matcher.Match_Data) return Natural is
   begin
      return Natural (Pcre2_Get_Ovector_Count_32 (Match_Data.Impl));
   ...
   function Get_Ovector_Pointer
     (Match_Data : Pcre.Wide_Wide_Matcher.Match_Data) return access unsigned_long
   is
   begin
      return
   ...
   function Get_Startchar (Match_Data : Pcre.Wide_Wide_Matcher.Match_Data) return unsigned_long is
   begin
   ...
   begin
      Retcode_2_Exception (Pcre2_Substring_Copy_Byname_32 (Match_Data.Impl,
                           Arg2 => As_PCRE2_SPTR32 (Name'Address),
   ...
   function Substring
     (Match_Data : Pcre.Wide_Wide_Matcher.Match_Data;
      Number     : Natural) return Wide_Wide_String  is
      Buffer : Wide_Wide_String (1 .. 1024);
      Last   : Natural;
   begin
   ...
   function Constant_Indexing (Self : Match_Data ; Index : Natural) return Wide_Wide_String is
   begin
   ...
   procedure Substring_Free (Arg1 : access Wide_Wide_Character) is
   begin
   ...
   begin
      Retcode_2_Exception (Pcre2_Substring_Length_Byname_32 (Match_Data.Impl,
                           As_PCRE2_SPTR32 (Name'Address),
                           Ret'Access));
      return Natural (Ret);
   ...
   begin
      Ret := Pcre2_Substring_Nametable_Scan_32 (Code.Impl,
                                               As_PCRE2_SPTR32 (Name'Address),
                                               First, Last);
      Retcode_2_Exception (Ret);
   ...
   function Number_From_Name
     (Code  : Pcre.Wide_Wide_Matcher.Code; Name  : Wide_Wide_String) return Natural
   is
      Ret : int;
   begin
      Ret := Pcre2_Substring_Number_From_Name_32 (Code.Impl,
                                                 As_PCRE2_SPTR32 (Name'Address));
      return Natural (Ret);
   ...
   function Serialize_Decode
     (Arg1 : System.Address; Arg2 : int; Arg3 : access Wide_Wide_Character;
   ...
   function Serialize_Get_Number_Of_Codes (Arg1 : access Wide_Wide_Character) return int
   is
   begin
      return
      raise Program_Error
   ...
   procedure Serialize_Free (Arg1 : access Wide_Wide_Character) is
   begin
   ...
   function Jit_Match
     (Arg1 : access constant Code; Arg2 : access Wide_Wide_Character;
   ...
   procedure Maketables_Free
     (Context :  General_Context; Tables : Wide_Wide_Character_Tables)
   is
   begin
   ...
   begin
      Object.Impl := Pcre2_General_Context_Create_32 (Arg1 => null,
                                                     Arg2 => null,
   ...
   begin
      Object.Impl := Pcre2_General_Context_Copy_32 (Object.Impl);
   end Adjust;
   ...
   begin
      if Object.Impl /= null then
         Pcre2_General_Context_Free_32 (Object.Impl);
         Object.Impl := null;
      end if;
   end Finalize;
   ...
   begin
      return Ret : Compile_Context do
         Ret.Impl := Pcre2_Compile_Context_Create_32 (From.Impl);
      end return;
   end;
   ...
   begin
      Object.Impl := Pcre2_Compile_Context_Copy_32 (Object.Impl);
   end Adjust;
   ...
   begin
      if Object.Impl /= null then
         Pcre2_Compile_Context_Free_32 (Object.Impl);
         Object.Impl := null;
      end if;
   end Finalize;
   ...
   begin
      return Ret : Match_Context do
         Ret.Impl := Pcre2_Match_Context_Create_32 (From.Impl);
      end return;
   end;
   ...
   begin
      Object.Impl := Pcre2_Match_Context_Copy_32 (Object.Impl);
   end Adjust;
   ...
   begin
      if Object.Impl /= null then
         Pcre2_Match_Context_Free_32 (Object.Impl);
         Object.Impl := null;
      end if;
   end Finalize;
   ...
   begin
      return Ret : Convert_Context do
         Ret.Impl := Pcre2_Convert_Context_Create_32 (From.Impl);
      end return;
   end;
   ...
   begin
      Object.Impl := Pcre2_Convert_Context_Copy_32 (Object.Impl);
   end Adjust;
   ...
   begin
      if Object.Impl /= null then
         Pcre2_Convert_Context_Free_32 (Object.Impl);
         Object.Impl := null;
      end if;
   end Finalize;
   ...
   begin
      Object.Impl := Pcre2_Code_Copy_With_Tables_32 (Object.Impl);
   end Adjust;
   ...
   begin
      if Object.Impl /= null then
         Pcre2_Code_Free_32 (Object.Impl);
         Object.Impl := null;
      end if;
   end Finalize;
   ...
   begin
      if Object.Impl /= null then
         Pcre2_Match_Data_Free_32 (Object.Impl);
         Object.Impl := null;
      end if;
   end Finalize;
