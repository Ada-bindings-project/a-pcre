...
package body Pcre.Wide_Wide_Matcher is
   ...
   is
   begin
      Retcode_2_Exception (Pcre2_Set_Bsr_32 (Context.Impl, Bsr_Type_Maping (Arg2)));
   end Set;
   ...
   is
   begin
      Retcode_2_Exception (Pcre2_Set_Compile_Extra_Options_32 (Arg1.Impl, Unsigned (Arg2)));
   ...
   is
   begin
      Retcode_2_Exception (Pcre2_Set_Max_Pattern_Length_32 (Arg1.Impl, unsigned_long (Arg2)));
   ...
   is
   begin
      Retcode_2_Exception (Pcre2_Set_Parens_Nest_Limit_32 (Context.Impl, UNSIGNED (Arg2)));
   ...
   function Get_Error_Message
     (Arg1 : int; Arg2 : access Wide_Wide_Character; Arg3 : unsigned_long) return int
   is
   begin
      pragma Compile_Time_Warning
