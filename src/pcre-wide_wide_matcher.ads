...
package Pcre.Wide_Wide_Matcher is
   ...
   procedure Converted_Pattern_Free (Arg1 : access Wide_Wide_Character) with Obsolescent;
   --
   --  -------------------------------------------------------------------------------------------------------------------------
