...
gen("src/pcre-matcher.ads", "src/pcre-wide_matcher.ads",replace)
gen("src/pcre-matcher.adb", "src/pcre-wide_matcher.adb",replace)
...
gen("src/pcre-matcher.ads", "src/pcre-wide_wide_matcher.ads",replace)
gen("src/pcre-matcher.adb", "src/pcre-wide_wide_matcher.adb",replace)
